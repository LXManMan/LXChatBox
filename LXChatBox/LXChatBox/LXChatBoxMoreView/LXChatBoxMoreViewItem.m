...
@interface LXChatBoxMoreViewItem()
@property (nonatomic, strong) UIButton *button;
@property (nonatomic, strong) UILabel *titleLabel;
@end
@implementation LXChatBoxMoreViewItem
 ...
 *  @return item
 */
+ (LXChatBoxMoreViewItem *) createChatBoxMoreItemWithTitle:(NSString *)title imageName:(NSString *)imageName{
    LXChatBoxMoreViewItem *item = [[LXChatBoxMoreViewItem alloc] init];
    item.title = title;
